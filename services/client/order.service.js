...
export class OrderService {
  ...
  async getOrdersByUserId(userId) {
    await axios
      .get(apiURL + endpoints.ORDER + `?user_id=${userId}`)
      .then((response) => {
  ...
  getStatisticalOrders() {
    ...
    let processingOrders = this.orders.filter(
      (order) => order.status === "Processing"
    ).length;
    let deliveringOrders = this.orders.filter(
      (order) => order.status === "Delivering"
    ).length;
    let totalSpent = this.orders.reduce(
                        ...
                        <div class="card order-card rounded-4">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-end gap-2">
                                    <a class="btn btn-outline-secondary btn-sm" href="order_detail.html?order_id=${
                                      order.id
                                    }">Xem chi tiết</a>
                    ...
                    <div class="col-12">
                        <div class="card order-card rounded-4">
                            <div class="card-body">
                                ...
                                <p class="mb-2"><strong>Giao đến:</strong> ${
                                ...
                                <div class="text-end">
                                    ...
                                    <a class="btn btn-secondary btn-sm" href="order_detail.html?order_id=${
                                      order.id
                                    }">Xem chi tiết</a>
                                </div>
                            </div>
